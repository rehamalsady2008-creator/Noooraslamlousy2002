        ...
        <div className="lg:col-span-5 bg-gradient-to-br from-emerald-800 to-teal-900 text-white rounded-3xl p-5 flex flex-col justify-between items-center text-center shadow-lg relative overflow-hidden">
          ...
          {nextPrayer && (
            <div className="space-y-4 z-10 w-full">
              ...
              {/* Countdown Number */}
              <div className="py-4 font-mono text-4xl font-extrabold tracking-widest text-white select-none drop-shadow-md bg-white/5 rounded-2xl border border-white/5">
                {countdownStr}
              </div>
